                  ...
                  <div className=" bg-card-foreground p-3 rounded-[14px]">
                    ...
                    <div className="flex items-center mt-2 justify-between gap-2">
                      ...
                      <div className=" bg-card p-3 px-4 flex-1 rounded-[14px]">
                        ...
                        <p className="xl:text-xl font-semibold text-[#2E963C]">
                          100 PartyBucks
                        </p>
                      </div>
                    </div>
              ...
              <div className=" w-full bg-card-foreground rounded-[20px] p-2">
                ...
                <div className=" px-4 py-4">
                  <Table>
                    <TableHeader>
                      <TableRow>
                        <TableHead className="bg-card dark:border-card-foreground font-medium rounded-tl-full rounded-bl-full text-center ">
                          Date
                        </TableHead>
                        <TableHead className="bg-card dark:border-card-foreground font-medium text-center">
                          Challenge
                        </TableHead>
                        <TableHead className="bg-card dark:border-card-foreground font-medium text-center">
                          Buy in
                        ...
                        <TableHead className="bg-card dark:border-card-foreground font-medium text-center rounded-tr-full rounded-br-full">
                          Winnings
                        </TableHead>
                      </TableRow>
                    </TableHeader>
                    <TableBody>
                      {Array.from({ length: 10 }, (_, index) => (
                        <TableRow key={index}>
                          <TableCell className="bg-card dark:border-card-foreground font-medium rounded-tl-full border-y-4 py-3 border-white rounded-bl-full text-center ">
                            Jul 6,2023
                          </TableCell>
                          <TableCell className="bg-card dark:border-card-foreground font-medium text-center border-y-4 py-3 border-white">
                            10-Pick
                          </TableCell>
                          <TableCell className="bg-card dark:border-card-foreground font-medium text-center border-y-4 py-3 border-white">
                            10.00
                          ...
                          <TableCell className="bg-card dark:border-card-foreground font-medium text-[#2E963C] text-center border-y-4 py-3 border-white rounded-tr-full rounded-br-full">
                            10.00
                          </TableCell>
                        </TableRow>
                      ))}
              ...
              <div className=" w-full p-4 xl:p-6 bg-card rounded-[14px]">
                ...
                <div className=" bg-card-foreground p-2 rounded-[20px]">
                  <div className="flex items-center gap-2">
                    <p className=" w-full bg-[#2E963C1A] text-[#2E963C] text-center font-semibold mt-4 rounded-full border border-[#1212121A] py-3 ">
                      Round 2
                    </p>
                    <p className=" w-full bg-[#2E963C1A] text-[#2E963C] text-center font-semibold mt-4 rounded-full border border-[#1212121A] py-3 ">
                      0 Pick Remaining
                    ...
                    <div className=" w-full flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        <Image
                          ...
                          className="w-[20px] md:w-[25px] "
                        />
                        <div className="text-sm font-semibold  2xl:text-lg bg-card px-5 py-3  rounded-full border-2 ">
                          <span> 1 2.23</span>
                        </div>
                      </div>
                    </div>
